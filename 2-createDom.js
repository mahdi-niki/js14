...
//<========================todo3==============================>
const firP = document.querySelector("#firp"); 
...
//<========================todo5==============================>
for (i = 0; i < 4; i++) {
  const idk = allPara[i].textContent;
  console.log(idk);
} 
//<========================todo6==============================>
fP.textContent = "please"; 
//<========================todo7==============================>
for (const paragraph of allPara) {
  paragraph.classList.add("idk"); 
}
...
fP.id = "fourth-p"; 
//<========================todo8==============================>
firP.style.border = "solid red";
sP.style.border = "dashed";
sP.style.backgroundColor = "rgb(100,200,256)";
tP.style.border = "inset";
tP.style.fontSize = "25px";
fP.style.border = "double"; 
//<========================todo9==============================>
for (let i = 0; i < 4; i++) {
  if (i % 2 === 0) {
